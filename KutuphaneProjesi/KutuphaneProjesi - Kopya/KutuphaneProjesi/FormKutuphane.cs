...
namespace KutuphaneProjesi
{
    public partial class FormKutuphane : Form
    {
        ...
        private void btnYayinKaydet_Click(object sender, EventArgs e)
        {
            Yayinevleri yayinevleri = new Yayinevleri();
            yayinevleri.Ad = txtYayınEvAdSoyad.Text;
            yayinevleri.Tel = txtYayınEvTelefon.Text;
            yayinevleri.Adres = txtYayınEvAdres.Text;

            List<string> gönderilecek = new List<string>();
            gönderilecek.Add(yayinevleri.Ad);
            gönderilecek.Add(yayinevleri.Adres);
            gönderilecek.Add(yayinevleri.Tel);
            string sorguCümlesi = "INSERT INTO tblYayinevleri  VALUES (@p1,@p2,@p3)";
            vt.YayinEviEkle(sorguCümlesi, gönderilecek);
        }
    }
}
